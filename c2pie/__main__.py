...
def parse_arguments():
    ...
    parser.add_argument("--input_file", type=Path, help="path to the input file to sign.")
    parser.add_argument(
        "-o",
        "--output",
        dest="output_file",
...
def main() -> None:
    ...
    extension_to_sign_def[file_extension](input_file_path)

    print(f"Successfully signed the file {input_file_path}!\nThe result was saved to {output_file_path}.")
